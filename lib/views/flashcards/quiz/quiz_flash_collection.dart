...
class QuizFlashCardCollectionWidget extends StatefulWidget {
  const QuizFlashCardCollectionWidget(this.flashCardCollection, {super.key});

  final FlashCardCollection flashCardCollection;
  @override
  State<QuizFlashCardCollectionWidget> createState() =>
      _QuizFlashCardCollectionWidgetState();
}

class _QuizFlashCardCollectionWidgetState
    extends State<QuizFlashCardCollectionWidget> {
  Color setCardColor() {
